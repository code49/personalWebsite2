{
  ...
  ffi = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-Dp8597s5NPd61v6rSWYr536H7tzesqP1wCNMKThWPUw=";
      type = "gem";
    };
    version = "1.17.3";
  };
  ...
  jekyll = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-TBFE2FelsrgNRbjPUTgolXmp+BNqrfpt1oSzH+K8GME=";
      type = "gem";
    };
    version = "4.4.1";
  };
  ...
  jekyll-sass-converter = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-oqatxM5pXs54D0A4jSB945blCR3dKHZ0QMeQekUBvto=";
      type = "gem";
    };
    version = "3.0.0";
  };
  ...
  jekyll-theme-yat = {
    dependencies = ["jekyll" "jekyll-feed" "jekyll-paginate" "jekyll-seo-tag" "jekyll-sitemap" "jekyll-spaceship"];
    groups = ["default"];
    platforms = [];
    source = {
      path = ./.;
